...
public class MultiplyStrings {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(multiplyStrings.multiply("123", "456").equals(
                Integer.toString(123 * 456)));
        System.out.println(multiplyStrings.multiply("45678", "123").equals(
                Integer.toString(45678 * 123)));
